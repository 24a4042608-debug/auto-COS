            ...
            {formSubmitted ? (
              <div className="bg-luxury-gold/5 border border-luxury-gold/20 p-8 text-center space-y-3">
                ...
                <p className="text-xs text-luxury-text-secondary leading-relaxed">
                  Your message has been logged in our Paris office. A concierge will reach out to you shortly.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <MagneticButton
                  type="submit"
                  className="w-full bg-luxury-text-primary text-white hover:bg-luxury-gold py-4 text-xs uppercase tracking-[0.25em] transition-all"
                >
                  Transmit Message
                </MagneticButton>
