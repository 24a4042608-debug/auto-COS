...
import { Search, Menu, X, Play, Film, Tv, BookOpen, ChevronDown } from "lucide-react";
...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "Movies", href: "/products", icon: Film },
    { name: "Series", href: "/collections", icon: Tv },
  ...
  return (
    <>
      ...
      <header
        className={cn(
          "fixed top-0 left-0w-full z-50 transition-all duration-500",
          scrolled
            ? "glass-luxury py-3"
      ...
      >
        <div className="max-w-screen-2xl mx-auto px-6 md:px-12 flex items-center justify-between gap-8">
          ...
          {/* Logo */}
          <Link href="/" className="flex-shrink-0 group focus:outline-none">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-[#E50914] flex items-center justify-center rounded-sm">
                <Play className="w-4 h-4 text-white fill-white" />
              </div>
              <span className="text-white font-bold text-xl tracking-tight group-hover:text-[#E50914] transition-colors duration-300">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            {/* CTA */}
            <Link href="/products">
              <button className="bg-[#E50914] hover:bg-[#f40612] text-white px-5 py-2 text-sm font-semibold rounded-sm transition-all duration-200 cursor-pointer flex items-center gap-2 hover:shadow-lg hover:shadow-red-900/40">
